...
//        $crec_reg_requests = CrecRegRequest::pluck('crec_comp_name_a', 'id')->prepend(trans('global.pleaseSelect'), '');
       ...
       $crec_reg_requests = CrecRegRequest::where('id',$crecRegRequestid)->pluck('crec_comp_name_a', 'id');
        ...
        $cities = ComCity::pluck('city_name_a', 'id')->prepend(trans('global.pleaseSelect'), '');
         return view('admin.crecRegPeople.create', compact('crec_reg_requests', 'person_nationalities', 'countries', 'governorates', 'cities','crecRegRequestid','person_types'));
    ...
    public function create()
    {
        ...
        return view('admin.crecRegPeople.create', compact('crec_reg_requests', 'person_nationalities', 'countries', 'governorates', 'cities', 'person_types'));
    }
    ...
    public function store(StoreCrecRegPersonRequest $request)
    {
       ...
       //  return redirect()->route('admin.front.create');
         return redirect()->route('admin.front.create', ['crecRegRequest' => $crecRegPerson->crec_reg_request_id ]);
        die();
   //     dd("done");
...
crec_reg_request_id.'/edit');
    ...
    public function edit(CrecRegPerson $crecRegPerson)
    {
        ...
        $crecRegPerson->load('crec_reg_request', 'person_nationality', 'country', 'governorate', 'city', 'person_type');

        return view('admin.crecRegPeople.edit', compact('crec_reg_requests', 'person_nationalities', 'countries', 'governorates', 'cities', 'person_types', 'crecRegPerson'));
    }
