...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.comAccount.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-accounts.update", [$comAccount->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="account_code">{{ trans('cruds.comAccount.fields.account_code') }}</label>
                <input class="form-control {{ $errors->has('account_code') ? 'is-invalid' : '' }}" type="text" name="account_code" id="account_code" value="{{ old('account_code', $comAccount->account_code) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_name') ? 'is-invalid' : '' }}" type="text" name="account_name" id="account_name" value="{{ old('account_name', $comAccount->account_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('account_address_a') ? 'is-invalid' : '' }}" type="text" name="account_address_a" id="account_address_a" value="{{ old('account_address_a', $comAccount->account_address_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" type="text" name="note" id="note" value="{{ old('note', $comAccount->note) }}">
                @if($errors->has('note'))
