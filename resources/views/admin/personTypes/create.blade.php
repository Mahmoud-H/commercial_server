...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.personType.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.person-types.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="person_type_name_a">{{ trans('cruds.personType.fields.person_type_name_a') }}</label>
                <input class="form-control {{ $errors->has('person_type_name_a') ? 'is-invalid' : '' }}" type="text" name="person_type_name_a" id="person_type_name_a" value="{{ old('person_type_name_a', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_type_name_l') ? 'is-invalid' : '' }}" type="text" name="person_type_name_l" id="person_type_name_l" value="{{ old('person_type_name_l', '') }}">
