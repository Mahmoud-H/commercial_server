...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.crecRegPerson.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.crec-reg-people.update", [$crecRegPerson->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('crec_reg_request') ? 'is-invalid' : '' }}" name="crec_reg_request_id" id="crec_reg_request_id" required>
                    @foreach($crec_reg_requests as $id => $entry)
                        <option value="{{ $id }}" {{ (old('crec_reg_request_id') ? old('crec_reg_request_id') : $crecRegPerson->crec_reg_request->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_id_no') ? 'is-invalid' : '' }}" type="text" name="person_id_no" id="person_id_no" value="{{ old('person_id_no', $crecRegPerson->person_id_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_type') ? 'is-invalid' : '' }}" type="text" name="person_type" id="person_type" value="{{ old('person_type', $crecRegPerson->person_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_name_a') ? 'is-invalid' : '' }}" type="text" name="person_name_a" id="person_name_a" value="{{ old('person_name_a', $crecRegPerson->person_name_a) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_name_l') ? 'is-invalid' : '' }}" type="text" name="person_name_l" id="person_name_l" value="{{ old('person_name_l', $crecRegPerson->person_name_l) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('person_birth_date') ? 'is-invalid' : '' }}" type="text" name="person_birth_date" id="person_birth_date" value="{{ old('person_birth_date', $crecRegPerson->person_birth_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_birth_place') ? 'is-invalid' : '' }}" type="text" name="person_birth_place" id="person_birth_place" value="{{ old('person_birth_place', $crecRegPerson->person_birth_place) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_gender') ? 'is-invalid' : '' }}" type="text" name="person_gender" id="person_gender" value="{{ old('person_gender', $crecRegPerson->person_gender) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('person_nationality') ? 'is-invalid' : '' }}" name="person_nationality_id" id="person_nationality_id">
                    @foreach($person_nationalities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('person_nationality_id') ? old('person_nationality_id') : $crecRegPerson->person_nationality->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id">
                    @foreach($countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $crecRegPerson->country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('governorate') ? 'is-invalid' : '' }}" name="governorate_id" id="governorate_id">
                    @foreach($governorates as $id => $entry)
                        <option value="{{ $id }}" {{ (old('governorate_id') ? old('governorate_id') : $crecRegPerson->governorate->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $crecRegPerson->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_address_a') ? 'is-invalid' : '' }}" type="text" name="person_address_a" id="person_address_a" value="{{ old('person_address_a', $crecRegPerson->person_address_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_address_l') ? 'is-invalid' : '' }}" type="text" name="person_address_l" id="person_address_l" value="{{ old('person_address_l', $crecRegPerson->person_address_l) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_street') ? 'is-invalid' : '' }}" type="text" name="person_street" id="person_street" value="{{ old('person_street', $crecRegPerson->person_street) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_bldg_no') ? 'is-invalid' : '' }}" type="text" name="person_bldg_no" id="person_bldg_no" value="{{ old('person_bldg_no', $crecRegPerson->person_bldg_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_tel_no') ? 'is-invalid' : '' }}" type="text" name="person_tel_no" id="person_tel_no" value="{{ old('person_tel_no', $crecRegPerson->person_tel_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_fax_no') ? 'is-invalid' : '' }}" type="text" name="person_fax_no" id="person_fax_no" value="{{ old('person_fax_no', $crecRegPerson->person_fax_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_mobile_no') ? 'is-invalid' : '' }}" type="text" name="person_mobile_no" id="person_mobile_no" value="{{ old('person_mobile_no', $crecRegPerson->person_mobile_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_po_box') ? 'is-invalid' : '' }}" type="text" name="person_po_box" id="person_po_box" value="{{ old('person_po_box', $crecRegPerson->person_po_box) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_email') ? 'is-invalid' : '' }}" type="text" name="person_email" id="person_email" value="{{ old('person_email', $crecRegPerson->person_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('person_notes') ? 'is-invalid' : '' }}" type="text" name="person_notes" id="person_notes" value="{{ old('person_notes', $crecRegPerson->person_notes) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_address_a') ? 'is-invalid' : '' }}" type="text" name="deleg_address_a" id="deleg_address_a" value="{{ old('deleg_address_a', $crecRegPerson->deleg_address_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_address_l') ? 'is-invalid' : '' }}" type="text" name="deleg_address_l" id="deleg_address_l" value="{{ old('deleg_address_l', $crecRegPerson->deleg_address_l) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_street') ? 'is-invalid' : '' }}" type="text" name="deleg_street" id="deleg_street" value="{{ old('deleg_street', $crecRegPerson->deleg_street) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_bldg_no') ? 'is-invalid' : '' }}" type="text" name="deleg_bldg_no" id="deleg_bldg_no" value="{{ old('deleg_bldg_no', $crecRegPerson->deleg_bldg_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_tel_no') ? 'is-invalid' : '' }}" type="text" name="deleg_tel_no" id="deleg_tel_no" value="{{ old('deleg_tel_no', $crecRegPerson->deleg_tel_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_fax_no') ? 'is-invalid' : '' }}" type="text" name="deleg_fax_no" id="deleg_fax_no" value="{{ old('deleg_fax_no', $crecRegPerson->deleg_fax_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_mobile_no') ? 'is-invalid' : '' }}" type="text" name="deleg_mobile_no" id="deleg_mobile_no" value="{{ old('deleg_mobile_no', $crecRegPerson->deleg_mobile_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_po_box') ? 'is-invalid' : '' }}" type="text" name="deleg_po_box" id="deleg_po_box" value="{{ old('deleg_po_box', $crecRegPerson->deleg_po_box) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_email') ? 'is-invalid' : '' }}" type="text" name="deleg_email" id="deleg_email" value="{{ old('deleg_email', $crecRegPerson->deleg_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deleg_website') ? 'is-invalid' : '' }}" type="text" name="deleg_website" id="deleg_website" value="{{ old('deleg_website', $crecRegPerson->deleg_website) }}">
