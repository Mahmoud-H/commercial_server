...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.crecRegBranch.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.crec-reg-branches.update", [$crecRegBranch->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('crec_reg_request') ? 'is-invalid' : '' }}" name="crec_reg_request_id" id="crec_reg_request_id" required>
                    @foreach($crec_reg_requests as $id => $entry)
                        <option value="{{ $id }}" {{ (old('crec_reg_request_id') ? old('crec_reg_request_id') : $crecRegBranch->crec_reg_request->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_no') ? 'is-invalid' : '' }}" type="number" name="branch_no" id="branch_no" value="{{ old('branch_no', $crecRegBranch->branch_no) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_brand_name') ? 'is-invalid' : '' }}" type="text" name="branch_brand_name" id="branch_brand_name" value="{{ old('branch_brand_name', $crecRegBranch->branch_brand_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('branch_open_date') ? 'is-invalid' : '' }}" type="text" name="branch_open_date" id="branch_open_date" value="{{ old('branch_open_date', $crecRegBranch->branch_open_date) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('country') ? 'is-invalid' : '' }}" name="country_id" id="country_id">
                    @foreach($countries as $id => $entry)
                        <option value="{{ $id }}" {{ (old('country_id') ? old('country_id') : $crecRegBranch->country->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('governorate') ? 'is-invalid' : '' }}" name="governorate_id" id="governorate_id">
                    @foreach($governorates as $id => $entry)
                        <option value="{{ $id }}" {{ (old('governorate_id') ? old('governorate_id') : $crecRegBranch->governorate->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('city') ? 'is-invalid' : '' }}" name="city_id" id="city_id">
                    @foreach($cities as $id => $entry)
                        <option value="{{ $id }}" {{ (old('city_id') ? old('city_id') : $crecRegBranch->city->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('city'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_address_a') ? 'is-invalid' : '' }}" type="text" name="branch_address_a" id="branch_address_a" value="{{ old('branch_address_a', $crecRegBranch->branch_address_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_address_l') ? 'is-invalid' : '' }}" type="text" name="branch_address_l" id="branch_address_l" value="{{ old('branch_address_l', $crecRegBranch->branch_address_l) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_street') ? 'is-invalid' : '' }}" type="text" name="branch_street" id="branch_street" value="{{ old('branch_street', $crecRegBranch->branch_street) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_bldg_no') ? 'is-invalid' : '' }}" type="text" name="branch_bldg_no" id="branch_bldg_no" value="{{ old('branch_bldg_no', $crecRegBranch->branch_bldg_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_tel_no') ? 'is-invalid' : '' }}" type="text" name="branch_tel_no" id="branch_tel_no" value="{{ old('branch_tel_no', $crecRegBranch->branch_tel_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_fax_no') ? 'is-invalid' : '' }}" type="text" name="branch_fax_no" id="branch_fax_no" value="{{ old('branch_fax_no', $crecRegBranch->branch_fax_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_mobile_no') ? 'is-invalid' : '' }}" type="text" name="branch_mobile_no" id="branch_mobile_no" value="{{ old('branch_mobile_no', $crecRegBranch->branch_mobile_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_po_box') ? 'is-invalid' : '' }}" type="text" name="branch_po_box" id="branch_po_box" value="{{ old('branch_po_box', $crecRegBranch->branch_po_box) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_email') ? 'is-invalid' : '' }}" type="text" name="branch_email" id="branch_email" value="{{ old('branch_email', $crecRegBranch->branch_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_website') ? 'is-invalid' : '' }}" type="text" name="branch_website" id="branch_website" value="{{ old('branch_website', $crecRegBranch->branch_website) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('branch_contact_person') ? 'is-invalid' : '' }}" type="text" name="branch_contact_person" id="branch_contact_person" value="{{ old('branch_contact_person', $crecRegBranch->branch_contact_person) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('branch_work_class') ? 'is-invalid' : '' }}" name="branch_work_class_id" id="branch_work_class_id">
                    @foreach($branch_work_classes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('branch_work_class_id') ? old('branch_work_class_id') : $crecRegBranch->branch_work_class->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
