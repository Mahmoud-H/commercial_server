    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-currencies.update", [$comCurrency->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currency_name_a') ? 'is-invalid' : '' }}" type="text" name="currency_name_a" id="currency_name_a" value="{{ old('currency_name_a', $comCurrency->currency_name_a) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currency_name_l') ? 'is-invalid' : '' }}" type="text" name="currency_name_l" id="currency_name_l" value="{{ old('currency_name_l', $comCurrency->currency_name_l) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('currency_symbol') ? 'is-invalid' : '' }}" type="text" name="currency_symbol" id="currency_symbol" value="{{ old('currency_symbol', $comCurrency->currency_symbol) }}">
