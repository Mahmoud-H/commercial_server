...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.comCountry.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-countries.update", [$comCountry->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="country_name_a">{{ trans('cruds.comCountry.fields.country_name_a') }}</label>
                <input class="form-control {{ $errors->has('country_name_a') ? 'is-invalid' : '' }}" type="text" name="country_name_a" id="country_name_a" value="{{ old('country_name_a', $comCountry->country_name_a) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country_name_l') ? 'is-invalid' : '' }}" type="text" name="country_name_l" id="country_name_l" value="{{ old('country_name_l', $comCountry->country_name_l) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iso_3') ? 'is-invalid' : '' }}" type="text" name="iso_3" id="iso_3" value="{{ old('iso_3', $comCountry->iso_3) }}">
                @if($errors->has('iso_3'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iso_num') ? 'is-invalid' : '' }}" type="text" name="iso_num" id="iso_num" value="{{ old('iso_num', $comCountry->iso_num) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('country_tel_prefix') ? 'is-invalid' : '' }}" type="text" name="country_tel_prefix" id="country_tel_prefix" value="{{ old('country_tel_prefix', $comCountry->country_tel_prefix) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality_a') ? 'is-invalid' : '' }}" type="text" name="nationality_a" id="nationality_a" value="{{ old('nationality_a', $comCountry->nationality_a) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nationality_l') ? 'is-invalid' : '' }}" type="text" name="nationality_l" id="nationality_l" value="{{ old('nationality_l', $comCountry->nationality_l) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('country_is_valid') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="country_is_valid" id="country_is_valid" value="1" {{ $comCountry->country_is_valid || old('country_is_valid', 0) === 1 ? 'checked' : '' }}>
