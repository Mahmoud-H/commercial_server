...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.comWorkClass.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-work-classes.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="work_class_desc_a">{{ trans('cruds.comWorkClass.fields.work_class_desc_a') }}</label>
                <input class="form-control {{ $errors->has('work_class_desc_a') ? 'is-invalid' : '' }}" type="text" name="work_class_desc_a" id="work_class_desc_a" value="{{ old('work_class_desc_a', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('work_class_desc_l') ? 'is-invalid' : '' }}" type="text" name="work_class_desc_l" id="work_class_desc_l" value="{{ old('work_class_desc_l', '') }}">
