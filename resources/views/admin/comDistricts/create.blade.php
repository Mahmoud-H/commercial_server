...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.comDistrict.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-districts.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district_name_a') ? 'is-invalid' : '' }}" type="text" name="district_name_a" id="district_name_a" value="{{ old('district_name_a', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('district_name_l') ? 'is-invalid' : '' }}" type="text" name="district_name_l" id="district_name_l" value="{{ old('district_name_l', '') }}">
