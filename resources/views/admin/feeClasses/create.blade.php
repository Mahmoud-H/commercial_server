...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.feeClass.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.fee-classes.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="fee_class_name_a">{{ trans('cruds.feeClass.fields.fee_class_name_a') }}</label>
                <input class="form-control {{ $errors->has('fee_class_name_a') ? 'is-invalid' : '' }}" type="text" name="fee_class_name_a" id="fee_class_name_a" value="{{ old('fee_class_name_a', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fee_class_name_l') ? 'is-invalid' : '' }}" type="text" name="fee_class_name_l" id="fee_class_name_l" value="{{ old('fee_class_name_l', '') }}">
