...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.comCity.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-cities.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city_name_a') ? 'is-invalid' : '' }}" type="text" name="city_name_a" id="city_name_a" value="{{ old('city_name_a', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city_name_l') ? 'is-invalid' : '' }}" type="text" name="city_name_l" id="city_name_l" value="{{ old('city_name_l', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('city_name_h') ? 'is-invalid' : '' }}" type="text" name="city_name_h" id="city_name_h" value="{{ old('city_name_h', '') }}">
