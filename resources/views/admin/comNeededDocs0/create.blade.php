    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.com-needed-docs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input readonly class="form-control {{ $errors->has('needed_doc_name_a') ? 'is-invalid' : '' }}" type="text" name="needed_doc_name_a" id="needed_doc_name_a" value="{{ old('needed_doc_name_a', '') }}" required>
