...
<head>
    ...
    <link href="{{ asset('css2/select2.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/bootstrap-datetimepicker.min.css') }}" rel="stylesheet" />
    <!--    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datetimepicker/4.17.47/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />-->
    <link href="{{ asset('css/adminltev3.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/all.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/cssfont.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/jquery.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/dataTables.bootstrap4.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/select.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/buttons.dataTables.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('css2/dropzone.min.css') }}" rel="stylesheet" />
    ...
    {{--<link href="{{ asset('css/rtl/adminlte.css') }}" rel="stylesheet" />--}}
    {{--    <link href="{{ asset('css//adminltev3.css') }}" rel="stylesheet" />--}}
    {{--<link href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css" rel="stylesheet" />--}}
    {{--<link href="https://cdn.datatables.net/1.10.19/css/dataTables.bootstrap4.min.css" rel="stylesheet" />--}}
    {{--<link href="https://cdn.datatables.net/select/1.3.0/css/select.dataTables.min.css" rel="stylesheet" />--}}
    {{--<link href="https://cdn.datatables.net/buttons/1.2.4/css/buttons.dataTables.min.css" rel="stylesheet" />--}}
    {{--<link href="{{ asset('css/rtl/custom.css') }}" rel="stylesheet" />--}}
    {{--    <link href="{{ asset('css/custom.css') }}" rel="stylesheet" />--}}
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            ...
            <strong> &copy;</strong> {{ trans('global.allRightsReserved') }} 2020-2021 وحدة الحاسوب وتكنولوجيا المعلومات .
        </footer>
    ...
    <script src="{{ asset('js2/select2.full.min.js') }}"></script>
    <script src="{{ asset('js2/moment.min.js') }}"></script>
    <script src="{{ asset('js2/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('js2/dataTables.bootstrap4.min.js') }}"></script>
    <script src="{{ asset('js2/dataTables.buttons.min.js') }}"></script>
    <script src="{{ asset('js2/dataTables.select.min.js') }}"></script>
    <script src="{{ asset('js2/buttons.flash.min.js') }}"></script>
    <script src="{{ asset('js2/buttons.html5.min.js') }}"></script>
    <script src="{{ asset('js2/buttons.print.min.js') }}"></script>
    <script src="{{ asset('js2/buttons.colVis.min.js') }}"></script>
    <script src="{{ asset('js2/pdfmake.min.js') }}"></script>
    <script src="{{ asset('js2/vfs_fonts.js') }}"></script>
    <script src="{{ asset('js2/jszip.min.js') }}"></script>
    <script src="{{ asset('js2/ckeditor.js') }}"></script>
    <script src="{{ asset('js2/moment2.min.js') }}"></script>
    <script src="{{ asset('js2/bootstrap-datetimepicker.min.js') }}"></script>
    <script src="{{ asset('js2/select23.full.min.js') }}"></script>
    <script src="{{ asset('js2/dropzone.min.js') }}"></script>
